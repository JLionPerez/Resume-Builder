...
nextButton[0].addEventListener("click", function () {
  var newPersonalTextSize = document.querySelector(
    "input[name=personal-text-size]:checked"
  );
  var newOrgTextSize = document.querySelector(
    "input[name=org-text-size]:checked"
  );
  var newSummaryTextSize = document.querySelector(
    "input[name=summary-text-size]:checked"
  );
  var newFontType = document.querySelector("input[name=font-type]:checked");
  var newBackgroundColor = document.querySelector(
    "input[name=background-color-type]:checked"
  );
...
nextButton[1].addEventListener("click", function () {
  ...
  var newPersonEmailInput = document.getElementById(
    "person-email-address-input"
  );
  var newPersonStreetInput = document.getElementById(
    "person-street-address-input"
  );
  ...
  if (
    ...
    newPersonStreetInput.value !== "" &&
    newPersonCityInput.value !== "" &&
    newPersonStateInput.value !== "" &&
    newPersonZipCodeInput.value !== "" &&
    newPersonNameInput.value !== ""
  ) {
...
nextButton[2].addEventListener("click", function () {
  ...
  var newRecipientStreetInput = document.getElementById(
  ...
  var newRecipientZipCodeInput = document.getElementById(
    "recipient-zipcode-input"
  );

  if (
    newDate.value !== "" &&
    newRecipientNameInput.value !== "" &&
    newRecipientTitleInput.value !== "" &&
    newCompanyNameInput.value !== "" &&
    newRecipientStreetInput.value !== "" &&
    newRecipientCityInput.value !== "" &&
    newRecipientStateInput.value !== "" &&
    newRecipientZipCodeInput.value !== ""
  ) {
